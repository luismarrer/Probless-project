...
urlpatterns = [
	...
	path('<int:workspace_id>/<int:department_id>/tickets/', views.manage_tickets, name='manage_tickets'),
	path('<int:workspace_id>/<int:department_id>/my_tickets/', views.my_tickets, name='my_tickets'),
